          ...
          <span class="align-middle">Ainthisar Workspace</span>
			...
			<ul class="sidebar-nav">
			    <li class="sidebar-header">
                    <h5 style="color:white">Login as : {{ Auth::user()->name }} <br> (Administrator)</h5> <br>
                    Pages
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/admin/project">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/admin/registeruser">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/admin/division">
                        ...
                        <span class="align-middle">Divisi</span>
                    </a>
                </li>
                <li class="sidebar-item">
