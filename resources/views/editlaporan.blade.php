...
<div class="row">
    ...
    @endif
    <!-- Alert message (end) -->
        <form method="post" action="/admin/laporan/{{$files->id}}" enctype="multipart/form-data">
            @method('put')
            @csrf
            ...
            <div class="form-group mb-4">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Enter Name" name="name" value="{{$files->name}}">
                </div>
                <!-- Error -->
                @if($errors->has('name'))
                <div class='text-danger mt-2'>
            ...
            <div class="form-group mb-4">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Enter Name" name="keterangan" value="{{$files->keterangan}}">
                </div>
                <!-- Error -->
            ...
            <div class="form-group ">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="/admin/laporan" class="btn btn-success">Back</a>
                </div>
            </div>
        </form>
    </div>
